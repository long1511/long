...
{
    $arrStatus = array(
        '0' => array('label' => 'Chờ xác nhận', 'class' => 'secondary'),
        '1' => array('label' => 'Đã tiếp nhận', 'class' => 'info'),
        '2' => array('label' => 'Đang giao hàng', 'class' => 'info'),
        '3' => array('label' => 'Đã thanh toán', 'class' => 'success'),
    );
