                                    ...
                                    <form class="user" method="POST">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                value="<?php echo isset($_SESSION['registerUser']) ? $_SESSION['registerUser'] : 'hoanglong@gmail.com'?>" name="email">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Mật khẩu" value="123456789"
                                                name="password">
                                        </div>
