        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="ft-item v1">
                    ...
                    <h2 class="slogan">FlatShop - HỆ THỐNG SHOP THỜI TRANG SÀNH ĐIỆU</h2>
                    <p>Thương hiệu độc quyền thuộc FlatShop</p>
                    <div class="connect">
                ...
                <div class="ft-item v2">
                    ...
                    <ul class="info hd-mb">
                        <li><span class="lnr lnr-home"></span>
                            <p>Nguyên xá,Bắc Từ Liêm, Hà Nội</p>
                        </li>
                        <li><span class="lnr lnr-phone-handset"></span>
                            <p>Điện thoại: <a href="tel:+842432001930" title="">(+84) 0000000000</a></p>
                        </li>
